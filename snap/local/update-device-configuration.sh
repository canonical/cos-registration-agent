...
REQUESTS_CA_BUNDLE=$SNAP_COMMON/rob-cos-shared-data/ca.crt ${SNAP}/bin/cos-registration-agent --shared-data-path ${SNAP_COMMON}/rob-cos-shared-data ${REGISTRATION_CMD_ARGS} update -c ${CONFIGURATION_FILE_PATH}
