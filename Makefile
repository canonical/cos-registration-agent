...
fmt:              ## Format code using black & isort.
	$(ENV_PREFIX)isort cos_registration_agent/
	$(ENV_PREFIX)black -l 79 cos_registration_agent/
	$(ENV_PREFIX)black -l 79 tests/

.PHONY: lint
lint:             ## Run pep8, black, mypy linters.
	$(ENV_PREFIX)flake8 cos_registration_agent/
	$(ENV_PREFIX)black -l 79 --check cos_registration_agent/
...
switch-to-poetry: ## Switch to poetry package manager.
	...
	@echo "cos_registration_agent = 'cos_registration_agent.__main__:main'" >> pyproject.toml
	...
	@echo "Please run 'poetry shell' or 'poetry run cos_registration_agent'"
