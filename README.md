...
- 🎯 Entry points to execute your program using `python -m <cos_registration_agent>` or `$ cos_registration_agent` with basic CLI argument parsing.
...
```bash
pip install cos_registration_agent
```

## Usage

```py
from cos_registration_agent import BaseClass
from cos_registration_agent import base_function
...
```bash
$ python -m cos_registration_agent
#or
$ cos_registration_agent
```
